...
OUT = "D:/dev/works/beenie/fall-into-trip/frontend/assets/images/"
MARK = "FIT"

SPECS = [
    # 이름, 한 변, 바탕(없으면 투명), 글자색, 글자가 차지할 폭 비율, 선 굵기 비율
    ("icon.png", 1024, (14, 14, 14, 255), (255, 255, 255, 255), 0.60, 0.030),
    ("favicon.png", 64, (14, 14, 14, 255), (255, 255, 255, 255), 0.66, 0.045),
    # 시작 화면은 흰 바탕 위에 얹힙니다(app.json). 그림 자체는 투명으로 둡니다.
    ("splash-icon.png", 1024, None, (14, 14, 14, 255), 0.66, 0.028),
    # 안드로이드는 동그랗게 잘라 냅니다. 가운데 66% 안에 들어와야 안 잘립니다.
    ("android-icon-foreground.png", 1024, None, (255, 255, 255, 255), 0.46, 0.030),
]
