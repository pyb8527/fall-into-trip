 ...
 * 보거나 숙소에 붙여 두는 종이입니다.
 *
 * <h3>웹과 앱이 같은 종이를 씁니다</h3>
 *
 * <p>여기는 글만 짭니다. 그것을 <b>어떻게 인쇄로 넘기는지</b>는 쪽마다
 * 다릅니다 — 웹은 숨은 iframe 에 넣고(print.web), 앱은 expo-print 에
 * 넘깁니다(print). 짜는 일을 양쪽에 두면 한쪽만 고치는 날 두 종이가
 * 달라집니다.
 */

/** 종이 한 장. */
export function paper(trip: TripDetail): string {
